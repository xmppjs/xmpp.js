...
function AnonClient(params) {
    ...
    if (params.host) {
        ...
        var attempt = SRV.connect(this.socket,
                                  ['_xmpp-AnonClient._tcp'], params.host, 5222);
...
sys.inherits(AnonClient, Connection.Connection);
exports.AnonClient = AnonClient;

AnonClient.prototype.onRawStanza = function(stanza) {
