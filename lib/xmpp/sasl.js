...
sys.inherits(Mechanism, EventEmitter);
...
function Plain() {
    ...
    this.authServer = function(auth) {
        this.username = "julien";
        this.emit("success");
    }
}
...
sys.inherits(XFacebookPlatform, Mechanism);
...
sys.inherits(Anonymous, Mechanism);
...
sys.inherits(DigestMD5, Mechanism);
