 ...
 * @param  {[type]} offeredMechs  methods offered by server
 * @param  {[type]} preferredMech preferred methods by client
 * @param  {[type]} availableMech available methods on client
...
function availableMechanisms(availableMech) {
    // default methods
    var mechanisms = [new Plain(), new Anonymous()];
    if (availableMech) {
