...
var checkServerIdentity = require('tls').checkServerIdentity
...
IncomingServer.prototype.handleTlsNegotiation = function handleTlsNegotiation (stanza) {
...
IncomingServer.prototype.verifyCertificate = function verifyCertificate () {
  // authorized ?
  ...
  // check identity
  if (!!checkServerIdentity(this.fromDomain, socket.getPeerCertificate())) { // eslint-disable-line
    debug('certificate failed identity check')
    return this.sendNotAuthorizedAndClose()
  }
...
IncomingServer.prototype.onSASLAuth = function onSASLAuth () {
...
IncomingServer.prototype.handleSASLExternal = function handleSASLExternal (stanza) {
  var self = this
...
IncomingServer.prototype.sendNotAuthorizedAndClose = function sendNotAuthorizedAndClose () {
