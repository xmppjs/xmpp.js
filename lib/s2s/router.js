...
var net = require('net'),
    ...
    DomainContext = require('./domaincontext'),
    nameprep = require('./util/nameprep'),
    dialbackkey = require('./util/dialbackkey'),
    IncomingServer = require('./session/incoming'),
    debug = require('debug')('s2srouter');
...
Router.prototype.acceptConnection = function (socket) {
    ...
    var inStream = new IncomingServer({
        setup: this.setupStream.bind(this),
        reconnect: false,
        socket: socket,
    }, this.credentials)
