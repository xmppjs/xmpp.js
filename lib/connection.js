...
function defaultInjection(emitter, opts) {
    ...
    /* jshint -W014 */
    newopts.initialDelay = (opts && (opts.initialReconnectDelay
                            ||  opts.reconnectDelay)) || INITIAL_RECONNECT_DELAY
    newopts.maxDelay = (opts &&   opts.maxReconnectDelay)  || MAX_RECONNECT_DELAY
    newopts.immediate = opts && opts.socket && typeof opts.socket !== 'function'
    newopts.type =      opts && opts.delayType
    newopts.emitter =   emitter
...
Connection.prototype._setupSocket = function (opts) {
    debug('setup socket')
    var previousOptions = {}
    var inject = reconnect(function () {
