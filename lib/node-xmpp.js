...
var Connection = require('./node-xmpp-core/lib/connection')
  , Client = require('./node-xmpp-client/client').Client
  , Component = require('./node-xmpp-component/component').Component
  , C2SServer = require('./node-xmpp-server/lib/c2s/server')
  , C2SStream = require('./node-xmpp-server/lib/c2s/stream')
  , JID = require('./node-xmpp-core/lib/jid').JID
...
exports.BOSHServer = require('./node-xmpp-server/bosh_server').BOSHServer
