...
test("escape `space cadet@example.com`", (t) => {
  ...
  t.is(esc.toString(), String.raw`space\20cadet@example.com`);
...
test('escape `call me "ishmael"@example.com`', (t) => {
  ...
  t.is(esc.toString(), String.raw`call\20me\20\22ishmael\22@example.com`);
